...
export class HttpService {
  ...
  // basePath: string = 'http://103.104.48.64:81/user/';
  // headerBasePath: string = "http://103.104.48.64:81/gridheader/";
  // gridPropertyBasePath: string = "http://103.104.48.64:81/treegridproperty/";
